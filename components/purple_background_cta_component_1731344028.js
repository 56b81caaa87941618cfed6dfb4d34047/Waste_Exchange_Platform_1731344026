        ...
        <div id="content" class="max-w-3xl mx-auto text-center">
          <div id="content-subtitle" class="flex">
            <div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3 text-transparent bg-gradient-to-r from-purple-500 to-purple-200">
              Discover the Hidden Value in Your Waste
            </div>
          </div>
          ...
          <div class="flex" id="content-body-container">
            <p id="content-body" class="flex-1 text-lg mb-8 text-slate-400">
              Join our eco-friendly marketplace where one person's waste becomes another's valuable resource. Start trading, reduce landfill, and make money from your unwanted items today!
            </p>
          </div>
          ...
          <!-- Added Image -->
          <img src="https://raw.githubusercontent.com/56b81caaa87941618cfed6dfb4d34047/Waste_Exchange_Platform_1731344026/main/images/ab2908e1456b42fd8347e7d8f81c3e5e.jpeg" alt="Illustration" class="mt-8 mx-auto max-w-full rounded-md" />
        </div>
      </div>
    </div>
  </section>
